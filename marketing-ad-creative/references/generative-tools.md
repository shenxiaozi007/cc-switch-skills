...
**Pricing:** ~$0.04/marketing-image (Gemini 2.5 Flash Image), ~$0.24/4K image (Nano Banana Pro)
...
**Docs:** [Gemini Image Generation](https://ai.google.dev/gemini-api/docs/marketing-image-generation)
...
**Pricing:** ~$0.01-0.06/marketing-image depending on model and resolution
...
**Pricing:** ~$0.06/marketing-image (API), ~$0.009/marketing-image (subscription)
...
**Docs:** [Veo on Vertex AI](https://cloud.google.com/vertex-ai/generative-ai/docs/marketing-video/overview)
...
**Docs:** [Kling AI Developer](https://klingai.com/global/dev/model/marketing-video)
...
**Docs:** [OpenAI Video Generation](https://platform.openai.com/docs/guides/marketing-video-generation)
...
```
1. Write ad script (use marketing-ad-creative skill for copy)
...
npx remotion render src/index.ts MyComposition out/marketing-video.mp4
